...
class ExamForm(FlaskForm):
    ...
    old_RX_Sphere_LE = SelectField('Sphère', choices=choices, validators=[validate_rx_add, validate_RX])
    old_RX_Ast_LE = SelectField('Ast', choices=choices, validators=[validate_rx_add, validate_RX])
    ...
    old_RX_Add_LE = SelectField('Add', choices=choices, validators=[validate_rx_add, validate_RX])
    choices = [(1/6, '1/6'), (2/6, '2/6'), (3/6, '3/6'), (4/6, '4/6'), (5/6, '5/6'), (6/6, '6/6')]
    old_RX_Acuity_LE = SelectField('Acuité', choices=choices)

    choices = [("%.2f" % (x / 4.0), "%.2f" % (x / 4.0)) for x in range(-80, 81)]  # Generating options from -20 to 20 by steps of 0.25
    old_RX_Sphere_RE = SelectField('Sphere', choices=choices, validators=[validate_rx_add, validate_RX])
    old_RX_Ast_RE = SelectField('Ast', choices=choices, validators=[validate_rx_add, validate_RX])
    choices = [(str(x), str(x)) for x in range(0, 181)]  # Generating options from 0 to 180
    old_RX_Axis_RE = SelectField('Axe', choices=choices)
    choices = [("%.2f" % (x / 4.0), "%.2f" % (x / 4.0)) for x in range(0, 81)]  # Generating options from -20 to 20 by steps of 0.25
    old_RX_Add_RE = SelectField('Add', choices=choices, validators=[validate_rx_add, validate_RX])
    choices = [(1/6, '1/6'), (2/6, '2/6'), (3/6, '3/6'), (4/6, '4/6'), (5/6, '5/6'), (6/6, '6/6')]
    ...
    choices = [("%.2f" % (x / 4.0), "%.2f" % (x / 4.0)) for x in range(-80, 81)]  # Generating options from -20 to 20 by steps of 0.25
    RX_objective_Sphere_LE = SelectField('Sphere', choices=choices, validators=[validate_rx_add, validate_RX])
    RX_objective_Ast_LE = SelectField('Ast', choices=choices, validators=[validate_rx_add, validate_RX])
    choices = [(str(x), str(x)) for x in range(0, 181)]  # Generating options from 0 to 180
    RX_objective_Axis_LE = SelectField('Axe', choices=choices, validators=[validate_RX])
    choices = [("%.2f" % (x / 4.0), "%.2f" % (x / 4.0)) for x in range(0, 81)]  # Generating options from -20 to 20 by steps of 0.25
    RX_objective_Add_LE = SelectField('Add', choices=choices, validators=[validate_rx_add, validate_RX])
    choices = [(1/6, '1/6'), (2/6, '2/6'), (3/6, '3/6'), (4/6, '4/6'), (5/6, '5/6'), (6/6, '6/6')]
    RX_objective_Acuity_LE = SelectField('Acuité', choices=choices)

    choices = [("%.2f" % (x / 4.0), "%.2f" % (x / 4.0)) for x in range(-80, 81)]  # Generating options from -20 to 20 by steps of 0.25
    RX_objective_Sphere_RE = SelectField('Sphere', choices=choices, validators=[validate_rx_add, validate_RX])
    RX_objective_Ast_RE = SelectField('Ast', choices=choices, validators=[validate_rx_add, validate_RX])
    choices = [(str(x), str(x)) for x in range(0, 181)]  # Generating options from 0 to 180
    RX_objective_Axis_RE = SelectField('Axe', choices=choices,validators=[validate_RX])
    choices = [("%.2f" % (x / 4.0), "%.2f" % (x / 4.0)) for x in range(0, 81)]  # Generating options from -20 to 20 by steps of 0.25
    RX_objective_Add_RE = SelectField('Add', choices=choices, validators=[validate_rx_add, validate_RX])
    choices = [(1/6, '1/6'), (2/6, '2/6'), (3/6, '3/6'), (4/6, '4/6'), (5/6, '5/6'), (6/6, '6/6')]
    RX_objective_Acuity_RE = SelectField('Acuité', choices=choices)

    choices = [("%.2f" % (x / 4.0), "%.2f" % (x / 4.0)) for x in range(-80, 81)]  # Generating options from -20 to 20 by steps of 0.25
    RX_subjective_Sphere_LE = SelectField('Sphere', choices=choices, validators=[validate_rx_add, validate_RX])
    RX_subjective_Ast_LE = SelectField('Ast', choices=choices, validators=[validate_rx_add, validate_RX])
    choices = [(str(x), str(x)) for x in range(0, 181)]  # Generating options from 0 to 180
    RX_subjective_Axis_LE = SelectField('Axe', choices=choices,validators=[validate_RX])
    choices = [("%.2f" % (x / 4.0), "%.2f" % (x / 4.0)) for x in range(0, 81)]  # Generating options from -20 to 20 by steps of 0.25
    RX_subjective_Add_LE = SelectField('Add', choices=choices, validators=[validate_rx_add, validate_RX])
    choices = [(1/6, '1/6'), (2/6, '2/6'), (3/6, '3/6'), (4/6, '4/6'), (5/6, '5/6'), (6/6, '6/6')]
    RX_subjective_Acuity_LE = SelectField('Acuité', choices=choices)

    choices = [("%.2f" % (x / 4.0), "%.2f" % (x / 4.0)) for x in range(-80, 81)]  # Generating options from -20 to 20 by steps of 0.25
    RX_subjective_Sphere_RE = SelectField('Sphere', choices=choices, validators=[validate_rx_add, validate_RX])
    RX_subjective_Ast_RE = SelectField('Ast', choices=choices, validators=[validate_rx_add, validate_RX])
    choices = [(str(x), str(x)) for x in range(0, 181)]  # Generating options from 0 to 180
    RX_subjective_Axis_RE = SelectField('Axe', choices=choices,validators=[validate_RX])
    choices = [("%.2f" % (x / 4.0), "%.2f" % (x / 4.0)) for x in range(0, 81)]  # Generating options from -20 to 20 by steps of 0.25
    RX_subjective_Add_RE = SelectField('Add', choices=choices, validators=[validate_rx_add, validate_RX])
    choices = [(1/6, '1/6'), (2/6, '2/6'), (3/6, '3/6'), (4/6, '4/6'), (5/6, '5/6'), (6/6, '6/6')]
